...
export function DesktopFloatingActions() {
  ...
  useEffect(() => {
    ...
    if (heroEl) heroRef.current = heroEl.offsetHeight;
  ...
  return (
    ...
    >
      ...
      <a
        ...
        title="Call Us"
        className="w-14 h-14 rounded-full bg-primary hover:bg-primary/85 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
      >
